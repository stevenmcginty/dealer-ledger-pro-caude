...
exports.toolDeclarations = [
    ...
    {
        name: 'get_stock_item',
        description: 'Full detail on one vehicle by its stock id, including mileage, owners, service history, MOT and spec. Use this the moment a customer asks anything specific about a car.',
        parameters: {
            type: genai_1.Type.OBJECT,
